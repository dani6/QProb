    ...
    <div id="login">
        ...
        <script>
            ...
            function showRegister(name,surname,email,tlf,department,user){
                ...
                width: 800,
                html: '<center><table class="register"><tr><td><?php echo $name.":";?></td><td><input placeholder="<?php echo $name;?>" value="'+name+'" class="input-field2" maxlength="20" id="name"></td>'
                    +'<td><?php echo $surname.":";?></td><td><input placeholder="<?php echo $surname;?>" value="'+surname+'" class="input-field2" maxlength="20" id="surname"></td></tr>'
                    +'<tr><td><?php echo $email.":";?></td><td><input placeholder="<?php echo $email;?>" value="'+email+'" class="input-field2" maxlength="30" id="email"></td>'
                    +'<td><?php echo $tlf.":";?></td><td><input placeholder="<?php echo $tlf;?>"  value="'+tlf+'" onkeyup="validateNumber();" type="number" class="input-field2" min="0" max="999999999" id="tlf"></tr>'
                    ...
                    +'<table class="register"><tr><td></td><td><?php echo $user_text.":";?></td><td><input placeholder="<?php echo $user_text;?>" value="'+user+'" class="input-field2" maxlength="50" id="Ruser"></td><td></td></tr>'
                    +'<tr><td></td><td><?php echo $password_text.":";?></td><td><input placeholder="<?php echo $password_text;?>"  class="input-field2" id="Rpass" type="password" value=""></td><td></td></tr>'
                    +'<tr><td></td><td><?php echo $confirm_password.":";?></td><td><input placeholder="<?php echo $confirm_password;?>" class="input-field2" id="Rpassconfirm" type="password" value=""></td><td></td></tr>'
                    +'</table></center>', 
