    ...
    <script>
        ...
        function addObservacion(id,observacion,presupuesto){
                swal({
                    ...
                    html: '<center><table class="formObservacion"><tr><td colspan="2"><input style="width:100%" tabindex="1" value="" placeholder="<?php echo $OBSERVACION;?>" class="input-field" id="observacion3"></td></tr><tr><td><?php echo $COMMENT_estimate;?> </td><td><input tabindex="2" type="number" value="0" class="input-field" id="presupuesto3"></td></table></center>',
