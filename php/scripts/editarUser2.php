<?php
    ...
    $consulta="SELECT U.ID ID_USUARIO,U.USER USUARIO_USUARIO, U.NOMBRE NOMBRE_USUARIO, U.APELLIDOS APELLIDOS_USUARIO, D.NOMBRE NOMBRE_DEPARTAMENTO, U.EMAIL EMAIL_USUARIO, U.TLF TLF_USUARIO FROM USUARIO U INNER JOIN DEPARTAMENTO D ON U.id_departamento=D.ID WHERE U.ID=".$id_post;
